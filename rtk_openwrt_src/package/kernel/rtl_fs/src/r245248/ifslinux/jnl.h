...
struct jnl_operations {
  ...
  void  (*free_meta)( handle_j *h, unsigned start, unsigned end );
  void  (*mark_bitmap)( handle_j *h, int (*cb_func)( void* ctx, unsigned start, unsigned end ), void* ctx );
  int   (*is_free_bitmap)( handle_j *h, unsigned start, unsigned end ); // for debugging
