...
ODM_InitAllWorkItems(IN PDM_ODM_T	pDM_Odm )
{
	...
	ODM_InitializeWorkItem(
		pDM_Odm,
		&(pDM_Odm->BeamformingInfo.TxbfInfo.Txbf_GetGtabWorkItem),
		(RT_WORKITEM_CALL_BACK)halComTxbf_GetGtabWorkItemCallback,
		(PVOID)pAdapter,
		"Txbf_GetGtabWorkItem");
#endif
}
...
ODM_FreeAllWorkItems(IN PDM_ODM_T	pDM_Odm )
{
	...
	ODM_FreeWorkItem((&pDM_Odm->BeamformingInfo.TxbfInfo.Txbf_GetGtabWorkItem));
#endif
