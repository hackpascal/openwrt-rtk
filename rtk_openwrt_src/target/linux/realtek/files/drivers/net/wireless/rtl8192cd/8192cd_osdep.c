...
//------------------------- david+2007-5-31
	...
	if( (priv->pmib->dot1180211AuthEntry.dot11EnablePSK!=PSK_WPA2) ||  (priv->pmib->dot1180211AuthEntry.dot11WPA2Cipher!=8) )
	{
		priv->pmib->dot1180211AuthEntry.dot11IEEE80211W=0;
		priv->pmib->dot1180211AuthEntry.dot11EnableSHA256=0;
		printk("This isn't WPA2-AES mode -> disable PMF function\n");		
	}
#endif
