	...
	)
{
	...
	if(Final_RF_Index > UpperBound)		//Upper bound = 10dB, if more htan upper bound, then move to bb swing max = +2dB
	{
		...
		Final_OFDM_Swing_Index = pRFCalibrateInfo->DefaultOfdmIndex + (pRFCalibrateInfo->Absolute_OFDMSwingIdx[RFPath] - (UpperBound*2));
	...
	else if(Final_RF_Index < LowerBound)	// lower bound = -5dB
	{
		...
		Final_OFDM_Swing_Index = pRFCalibrateInfo->DefaultOfdmIndex - ((LowerBound*2) - pRFCalibrateInfo->Absolute_OFDMSwingIdx[RFPath]);
