...
#if defined(M2U_DELETE_CHECK) || defined(CONFIG_RTL_IGMPSNOOPING_MAC_BASED)
static  uint32 rtl_processJoin(uint32 moduleIndex, uint32 ipVersion, uint32 portNum, uint32 *clientAddr, uint8 *clientmacAddr, uint8 *pktBuf); // process join report packet 
