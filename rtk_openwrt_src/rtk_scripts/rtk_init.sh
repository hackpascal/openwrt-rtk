...
#	Remove source code of rtl_fs
	rm -f package/kernel/rtl_fs/src/r245248/ifslinux/rtkjnl.c
	cp -fr $1/package/kernel/rtl_fs/src/r245248/ifslinux/rtkjnl.S package/kernel/rtl_fs/src/r245248/ifslinux/
